...
Nhiệm vụ của bạn: từ một keyword đầu vào, hãy trả về một mảng JSON các tag liên quan, có thể bao gồm:
...
Quy tắc:
- Bắt Buộc Chỉ trả về mảng JSON thuần túy, không thêm giải thích.
